...
function checkPackageAndRenderConfig() {
  ...
  if (!server.includes("/assets/nft/nft-01.png") || !server.includes('requested.startsWith("/assets/nft/")')) throw new Error("server.js must expose the cut NFT photo assets.");
  if (!server.includes('id: "duck-agent"') || !server.includes('image: "/assets/nft/nft-20.png"')) throw new Error("server.js must attach photo NFT assets to gift symbols.");
