...
function checkPackageAndRenderConfig() {
  ...
  for (const api of ["/api/orbit-plus", "/api/stories", "/api/stories/react", "/api/friends/request", "/api/friends/action", "/api/customization/buy", "/api/customization/equip", "/api/minigames/play", "/api/pair-games/create", "/api/pair-games/play", "/api/pair-games/action", "/api/clans", "/api/preferences"]) {
