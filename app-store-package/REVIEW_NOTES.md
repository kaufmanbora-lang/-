...
8. Open Profile and test the visible logout button plus legal links.
9. Open Security and test session view.
10. Account deletion is available at Security -> Delete my account. Do not delete the review demo account unless you intend to recreate it.
...
- user agreement at `/terms.html`, including UGC rules, reports, blocking, moderation, account deletion, and Apple App Store terms.
