...
const CUSTOMIZATION_CATALOG = [
  { id: "theme-midnight", type: "theme", name: "Midnight Blue", price: 0, value: "midnight" },
  { id: "theme-aurora", type: "theme", name: "Aurora Glass", price: 650, value: "aurora" },
  { id: "theme-neon", type: "theme", name: "Neon Pulse", price: 900, value: "neon" },
  { id: "frame-silver", type: "frame", name: "Silver Frame", price: 450, value: "silver" },
  { id: "frame-gold", type: "frame", name: "Gold Frame", price: 1200, value: "gold" },
  { id: "frame-diamond", type: "frame", name: "Diamond Frame", price: 2500, value: "diamond" },
  { id: "effect-glow", type: "effect", name: "Message Glow", price: 700, value: "glow" },
  { id: "effect-comet", type: "effect", name: "Comet Trail", price: 1500, value: "comet" },
  { id: "badge-verified", type: "badge", name: "Trust Spark", price: 1100, value: "trust-spark" }
];
...
function publicUser(user, includeEmail = false) {
  ...
  return {
    ...
    messageEffect: includeEmail ? (user.messageEffect || "") : undefined,
...
async function handleApi(req, res, url) {
  ...
  if (url.pathname === "/api/customization/buy" && req.method === "POST") {
    ...
    if (item.type === "theme") auth.user.profileTheme = item.value;
    if (item.type === "frame") auth.user.profileFrame = item.value;
    if (item.type === "effect") auth.user.messageEffect = item.value;
    if (item.type === "badge") auth.user.profileBadge = item.value;
