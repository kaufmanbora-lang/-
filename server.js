...
const NFT_BACKGROUNDS = [
  { id: "aurora", name: "Blue Aurora", tier: 1, colors: ["#1d9bf0", "#0f3d7a"], accent: "#9ee7ff", image: "/assets/nft/nft-01.png" },
  { id: "mint", name: "Mint Glow", tier: 1, colors: ["#61d66b", "#185a3b"], accent: "#d6ff9f", image: "/assets/nft/nft-02.png" },
  { id: "violet", name: "Violet Dream", tier: 2, colors: ["#8b5cf6", "#38136b"], accent: "#f0abfc", image: "/assets/nft/nft-03.png" },
  { id: "sunset", name: "Sunset Gold", tier: 2, colors: ["#f59e0b", "#7c2d12"], accent: "#fde68a", image: "/assets/nft/nft-04.png" },
  { id: "reef", name: "Cyber Reef", tier: 2, colors: ["#22d3ee", "#0f766e"], accent: "#a7f3d0", image: "/assets/nft/nft-05.png" },
  { id: "rose", name: "Rose Neon", tier: 2, colors: ["#fb7185", "#831843"], accent: "#fecdd3", image: "/assets/nft/nft-06.png" },
  { id: "midnight", name: "Midnight City", tier: 3, colors: ["#334155", "#020617"], accent: "#93c5fd", image: "/assets/nft/nft-07.png" },
  { id: "plasma", name: "Plasma Wave", tier: 3, colors: ["#ec4899", "#4c1d95"], accent: "#67e8f9", image: "/assets/nft/nft-08.png" },
  { id: "jade", name: "Jade Matrix", tier: 3, colors: ["#10b981", "#064e3b"], accent: "#bef264", image: "/assets/nft/nft-09.png" },
  { id: "ice", name: "Ice Glass", tier: 3, colors: ["#bae6fd", "#2563eb"], accent: "#ffffff", image: "/assets/nft/nft-10.png" },
  { id: "ember", name: "Ember Core", tier: 4, colors: ["#fb923c", "#450a0a"], accent: "#fed7aa", image: "/assets/nft/nft-11.png" },
  { id: "galaxy", name: "Deep Galaxy", tier: 4, colors: ["#7c3aed", "#020617"], accent: "#c4b5fd", image: "/assets/nft/nft-12.png" },
  { id: "matrix", name: "Green Matrix", tier: 4, colors: ["#22c55e", "#052e16"], accent: "#86efac", image: "/assets/nft/nft-13.png" },
  { id: "royal", name: "Royal Night", tier: 4, colors: ["#2563eb", "#172554"], accent: "#facc15", image: "/assets/nft/nft-14.png" },
  { id: "pearl", name: "Pearl Sky", tier: 5, colors: ["#f8fafc", "#38bdf8"], accent: "#0f172a", image: "/assets/nft/nft-15.png" },
  { id: "obsidian", name: "Obsidian Gold", tier: 5, colors: ["#111827", "#000000"], accent: "#fbbf24", image: "/assets/nft/nft-16.png" },
  { id: "holo", name: "Holo Storm", tier: 5, colors: ["#a78bfa", "#22d3ee"], accent: "#fef3c7", image: "/assets/nft/nft-17.png" },
  { id: "crimson", name: "Crimson Rift", tier: 5, colors: ["#dc2626", "#1f0505"], accent: "#fecaca", image: "/assets/nft/nft-18.png" },
  { id: "cosmic", name: "Cosmic Blue", tier: 6, colors: ["#0ea5e9", "#312e81"], accent: "#e0f2fe", image: "/assets/nft/nft-19.png" },
  { id: "legend", name: "Legend Gold", tier: 7, colors: ["#facc15", "#7c2d12"], accent: "#ffffff", image: "/assets/nft/nft-20.png" }
];
const NFT_SYMBOLS = [
  { id: "duck-agent", name: "Duck Agent", tier: 1, icon: "\u{1F986}", image: "/assets/nft/nft-01.png" },
  { id: "frog-hood", name: "Frog Hoodie", tier: 1, icon: "\u{1F438}", image: "/assets/nft/nft-02.png" },
  { id: "dog-cap", name: "Dog Beanie", tier: 1, icon: "\u{1F436}", image: "/assets/nft/nft-03.png" },
  { id: "owl-mage", name: "Owl Scout", tier: 2, icon: "\u{1F989}", image: "/assets/nft/nft-06.png" },
  { id: "cat-shadow", name: "Shadow Cat", tier: 2, icon: "\u{1F431}", image: "/assets/nft/nft-07.png" },
  { id: "penguin-ice", name: "Ice Penguin", tier: 2, icon: "\u{1F427}", image: "/assets/nft/nft-08.png" },
  { id: "alien-peace", name: "Alien Peace", tier: 2, icon: "\u{1F47D}", image: "/assets/nft/nft-11.png" },
  { id: "retro-pc", name: "Retro PC", tier: 2, icon: "\u{1F5A5}\uFE0F", image: "/assets/nft/nft-12.png" },
  { id: "monkey-band", name: "Monkey Dojo", tier: 2, icon: "\u{1F412}", image: "/assets/nft/nft-13.png" },
  { id: "ghost-beanie", name: "Ghost Beanie", tier: 2, icon: "\u{1F47B}", image: "/assets/nft/nft-14.png" },
  { id: "captain-duck", name: "Captain Duck", tier: 3, icon: "\u{1F986}", image: "/assets/nft/nft-16.png" },
  { id: "octo-ninja", name: "Octo Ninja", tier: 3, icon: "\u{1F419}", image: "/assets/nft/nft-17.png" },
  { id: "black-dragon", name: "Black Dragon", tier: 4, icon: "\u{1F409}", image: "/assets/nft/nft-18.png" },
  { id: "pizza-cool", name: "Pizza Cool", tier: 3, icon: "\u{1F355}", image: "/assets/nft/nft-19.png" },
  { id: "bunny-royal", name: "Bunny Royal", tier: 3, icon: "\u{1F430}", image: "/assets/nft/nft-20.png" },
  { id: "robot-smile", name: "Neon Robot", tier: 4, icon: "\u{1F916}", image: "/assets/nft/nft-04.png" },
  { id: "panda-runner", name: "Panda Runner", tier: 3, icon: "\u{1F43C}", image: "/assets/nft/nft-05.png" },
  { id: "shark-hood", name: "Shark Hoodie", tier: 3, icon: "\u{1F988}", image: "/assets/nft/nft-10.png" },
  { id: "fox-sly", name: "Fox Rogue", tier: 3, icon: "\u{1F98A}", image: "/assets/nft/nft-15.png" },
  { id: "raven-chain", name: "Raven Chain", tier: 4, icon: "\u{1F426}\u200D\u2B1B", image: "/assets/nft/nft-09.png" },
...
function nftPrimaryPrice(backgroundId, symbolId) {
  ...
  const rarityPrice = 45 + background.tier * 34 + symbol.tier * 42 + background.tier * symbol.tier * 8;
  const popularityPrice = sold * Math.max(7, Math.round((background.tier + symbol.tier) * 3.5));
  return Math.max(5, Math.round((rarityPrice + popularityPrice) / 5) * 5);
}
...
function nftMarketData(viewer) {
  const featured = NFT_BACKGROUNDS.flatMap((background) => (
    NFT_SYMBOLS.map((symbol) => serializeNftCombo(background, symbol))
  ))
...
function serveStatic(req, res, pathname) {
  ...
  const isNftAsset = requested.startsWith("/assets/nft/") && requested.endsWith(".png");
