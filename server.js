...
function loadStore() {
  ...
  try {
    ...
    const fresh = { users: [], sessions: [], messages: [], groups: [], pushSubscriptions: [], vapidKeys: null, createdAt: new Date().toISOString() };
...
function saveUpload(input, options = {}) {
  ...
  if (!imagesOnly && !MIME_EXT[mimeType] && !isImageMime(mimeType)) {
