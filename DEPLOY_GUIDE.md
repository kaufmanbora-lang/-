...
## 2.1. Настроить письма с кодами подтверждения

Чтобы при регистрации и смене почты реально приходил 6-значный код, в Render открой сервис `orbit-chat` -> `Environment` и добавь один из вариантов.
