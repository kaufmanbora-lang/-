...
## 2.1. Настроить письма подтверждения

Чтобы при регистрации реально приходило письмо, в Render открой сервис `orbit-chat` -> `Environment` и добавь один из вариантов.
