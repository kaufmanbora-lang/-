...
- Пароль администратора по умолчанию: `123487`.
...
- `node --check sw.js`
- `node qa-check.js`
- Deep Admin QA: неверный админ-пароль, вход по `123487`, создание админ-аккаунта, бан пользователя, запрет входа забаненному, разбан.
